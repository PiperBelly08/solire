...
urlpatterns = [
    ...
    path("api/recommendation-list", views.list_data_with_recommendation, name="list_data_with_recommendation"),
    path("api/recommend/", views.recommend_plant, name="recommendation_plants"),
